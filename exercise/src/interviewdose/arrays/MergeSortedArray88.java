...
public class MergeSortedArray88 {
	...
	public static void merge(int[] nums1, int m, int[] nums2, int n) {
		//starting index for nums1 array 
		int nums1Indx= m-1 ;
		int nums2Indx = n-1;
		int fillArrayIndx = nums1.length-1;
		
		while(nums1Indx!=-1 && nums2Indx!=-1) {
			if(nums1[nums1Indx]<=nums2[nums2Indx]) {
				nums1[fillArrayIndx--]=nums2[nums2Indx--];
			}else {
				nums1[fillArrayIndx--]=nums1[nums1Indx--];
			}
		}
